...
export default function Hero() {
  ...
  // Signature Scroll Moment: Hero typography subtle reaction on scroll
  const heroScale = useTransform(scrollY, [0, 500], [1, 0.95]);
  const heroOpacity = useTransform(scrollY, [0, 450], [1, 0.15]);

  return (
    <section className="relative flex h-screen min-h-screen w-full items-center justify-center bg-transparent px-6 pt-20 text-white md:px-12">

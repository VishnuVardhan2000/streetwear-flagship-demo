...
export default function HeroContent() {
  return (
    <div className="z-20 flex flex-col items-start space-y-8 text-left">
      {/* Badge */}
      <motion.div
      ...
      <motion.h1
        ...
        className="font-serif text-6xl leading-[0.85] font-light tracking-tight text-white uppercase sm:text-7xl md:text-8xl lg:text-9xl"
      >
        FLIQ{' '}
      ...
      <motion.p
        ...
        className="max-w-md font-sans text-xs leading-relaxed font-light tracking-[0.25em] text-zinc-400 uppercase md:text-sm"
      >
